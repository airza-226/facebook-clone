          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col gap-0.5">
                <p className="text-[0.75rem] font-semibold text-gray-500 uppercase tracking-wide leading-none">
                  {field.label}
                </p>
                <p className="text-[0.9375rem] text-gray-100 leading-tight mt-1">
                  {field.value || 'Not set'}
                </p>
              </div>
            </div>
        ...
        <div className="flex flex-col gap-3">
          {['Current password', 'New password', 'Confirm new password'].map((label) => (
            <div key={label} className="flex flex-col gap-1.5">
              <label className="text-[0.75rem] font-semibold text-gray-400 uppercase tracking-wide">
                {label}
              </label>
              <input
                type="password"
                placeholder="••••••••"
                className="w-full px-3 py-2.5 bg-[#18191a] border border-[#3a3b3c] rounded-lg text-[0.9375rem] text-gray-100 placeholder:text-gray-600 outline-none focus:border-[#1877f2] focus:ring-1 focus:ring-[#1877f2]/20 transition-all duration-150"
              />
            </div>
          ))}
        </div>
      ...
      <SettingsCard danger>
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-[0.8125rem] text-gray-400 leading-relaxed mt-0.5">
              Once you delete your account, there is no going back.
            </p>
          </div>
        </div>
        <button className="px-4 py-2 bg-red-500/10 hover:bg-red-500/20 active:scale-[0.97] text-red-400 hover:text-red-300 text-[0.875rem] font-semibold rounded-lg border border-red-500/20 transition-all duration-150 cursor-pointer">
          Delete account
        </button>
      </SettingsCard>
