...
const NotificationPanel = () => {
  return (
    <section aria-label="Notification settings" className="flex flex-col gap-y-3">
      <div className="bg-[#242526] border border-[#3a3b3c] rounded-xl overflow-hidden">
        {notificationItems.map((item, i) => (
          ...
          >
            <div className="flex flex-col gap-0.5">
              <p className="text-[0.9375rem] font-semibold text-gray-100 leading-tight">{item.label}</p>
              <p className="text-[0.8125rem] text-gray-400 leading-relaxed">{item.desc}</p>
            </div>
